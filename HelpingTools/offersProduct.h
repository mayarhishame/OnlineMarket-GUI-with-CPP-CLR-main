...
namespace HelpingTools {
	...
	/// <summary>
	/// Summary for offersProduct
	/// </summary>
	public ref class offersProduct : public System::Windows::Forms::UserControl
	{
	public:
		int pos;
		offersProduct(void)
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(offersProduct::typeid));
			...
			this->button1->Click += gcnew System::EventHandler(this, &offersProduct::button1_Click);
			// 
			// pname
			// 
			...
			this->panel2->Location = System::Drawing::Point(164, 126);
			this->panel2->Name = L"panel2";
			this->panel2->Size = System::Drawing::Size(105, 37);
			...
			this->label1->Font = (gcnew System::Drawing::Font(L"Montserrat", 14.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
		...
		public: event EventHandler<int>^ viewProduct;
#pragma endregion
